...
public class UpiUtils {
    ...
    /**
     * Parse settings token and change settings object
     *
     * @param settings The current settings
     * @param name     Name of the settings
     * @param value    Value the setting should be set to
     * @throws PokerProtocolException if the setting/value is invalid or could not be parsed
     */
    public static void parseSetting(GameSettings settings, String name, String value) throws PokerProtocolException {
        switch (name) {
            case "smallBlind":
                settings.setSmallBlind(parseLongToken(value));
                break;
            case "bigBlind":
                settings.setBigBlind(parseLongToken(value));
                break;
            case "maxNumberOfPlayers":
                settings.setMaxNumberOfPlayers(parseIntToken(value));
                break;
            case "startStack":
                settings.setStartStack(parseLongToken(value));
                break;
            case "levelDuration":
                settings.setLevelDuration(parseIntToken(value));
                break;
            case "playerClock":
